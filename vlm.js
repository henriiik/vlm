...
var _henriiik$vlm$Cursor$cmp = F2(
	function (a, b) {
...
var _henriiik$vlm$Line$split = F2(
	function (i, a) {
		return {
			ctor: '_Tuple2',
...
var _henriiik$vlm$Line$deleteChar = F2(
	function (i, a) {
		var s = A2(_henriiik$vlm$Line$split, i, a);
		return A2(
...
var _henriiik$vlm$Line$insert = F3(
	function (i, a, b) {
		var s = A2(_henriiik$vlm$Line$split, i, b);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Tuple$first(s),
			A2(
...
var _henriiik$vlm$Buffer$last = function (buf) {
	return A2(
		_henriiik$vlm$Buffer$get,
		_elm_lang$core$Array$length(buf) - 1,
		buf);
};
var _henriiik$vlm$Buffer$join = F2(
	function (a, b) {
		var i = _elm_lang$core$Array$length(a) - 1;
		var line = A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_henriiik$vlm$Buffer$get, i, a),
			A2(_henriiik$vlm$Buffer$get, 0, b));
		return A2(
			_elm_lang$core$Array$append,
			A3(_elm_lang$core$Array$slice, 0, -1, a),
			A3(_henriiik$vlm$Buffer$set, 0, line, b));
	});
...
var _henriiik$vlm$Buffer$split = F2(
	function (cur, buf) {
		...
		var _p0 = A2(
			...
			cur.col,
			A2(_henriiik$vlm$Buffer$get, 0, bot));
		var left = _p0._0;
		var right = _p0._1;
		var top = A2(_henriiik$vlm$Buffer$splitLeft, cur.row, buf);
		return {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Array$push, left, top),
...
var _henriiik$vlm$Main$editObjectStatus = function (obj) {
	var _p0 = obj;
	if (_p0.ctor === 'Just') {
		if (_p0._0.ctor === 'Inner') {
			return 'i';
		} else {
			return 'a';
		}
...
var _henriiik$vlm$Main$editCommandStatus = function (cmd) {
	var _p1 = cmd;
	if (_p1.ctor === 'Delete') {
		return 'd';
	} else {
...
var _henriiik$vlm$Main$editRepeatStatus = function (i) {
	return _elm_lang$core$Native_Utils.eq(i, 0) ? '' : _elm_lang$core$Basics$toString(i);
};
var _henriiik$vlm$Main$editStatus = function (edt) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_henriiik$vlm$Main$editRepeatStatus(edt.repeat),
		A2(
			_elm_lang$core$Basics_ops['++'],
			_henriiik$vlm$Main$editCommandStatus(edt.command),
			_henriiik$vlm$Main$editObjectStatus(edt.object)));
};
var _henriiik$vlm$Main$cursorStatus = F2(
	function (s, c) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			s,
						...
						A2(
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										A2(_henriiik$vlm$Main$cursorStatus, ', cursor ', m.cursor),
										A2(
											_elm_lang$core$Basics_ops['++'],
											A2(_henriiik$vlm$Main$cursorStatus, ', selection ', m.selectionStart),
											A2(
												_elm_lang$core$Basics_ops['++'],
												', ',
												_henriiik$vlm$Main$editStatus(m.edit))))))))))));
};
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'width',
							_1: _henriiik$vlm$Main$cursorWidth(m)
						},
						_1: {
							ctor: '::',
							_0: {
	...
	function (m, s, row, l) {
		return A2(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'top',
								_1: _henriiik$vlm$Main$asPx(row * 15)
							},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: A4(_henriiik$vlm$Main$renderSelection, m, s, row, l),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _henriiik$vlm$Main$withEdit = F2(
	function (mdl, edt) {
		return _elm_lang$core$Native_Utils.update(
			mdl,
			{edit: edt});
	});
var _henriiik$vlm$Main$withEditRepeat = F2(
	function (i, edt) {
		return _elm_lang$core$Native_Utils.update(
			edt,
			{repeat: (edt.repeat * 10) + i});
	});
var _henriiik$vlm$Main$withEditMotion = F2(
	function (mtn, edt) {
		return _elm_lang$core$Native_Utils.update(
			edt,
			{
				motion: _elm_lang$core$Maybe$Just(mtn)
			});
	});
var _henriiik$vlm$Main$doKeyUp = F2(
	function (c, m) {
		var _p5 = c;
		switch (_p5) {
			case 16:
...
var _henriiik$vlm$Main$doLog = F3(
	function (s, c, m) {
		return _elm_lang$core$Native_Utils.update(
			m,
			{
				log: A3(_henriiik$vlm$Main$newLog, s, c, m.log)
			});
	});
var _henriiik$vlm$Main$motionDown = function (m) {
	return (_elm_lang$core$Native_Utils.cmp(m.cursor.row, m.height - 1) > -1) ? m : _elm_lang$core$Native_Utils.update(
		m,
		{
			cursor: _henriiik$vlm$Cursor$down(m.cursor)
		});
};
var _henriiik$vlm$Main$motionUp = function (m) {
	return _elm_lang$core$Native_Utils.eq(m.cursor.row, 0) ? m : _elm_lang$core$Native_Utils.update(
		m,
		{
			cursor: _henriiik$vlm$Cursor$up(m.cursor)
		});
};
var _henriiik$vlm$Main$motionLeft = function (m) {
	return _elm_lang$core$Native_Utils.eq(m.cursor.col, 0) ? m : _elm_lang$core$Native_Utils.update(
		m,
		{
			cursor: _henriiik$vlm$Cursor$left(m.cursor)
		});
};
var _henriiik$vlm$Main$pasteBefore = function (m) {
	var _p6 = A3(_henriiik$vlm$Register$insert, m.register, m.cursor, m.buffer);
	var buf = _p6._0;
	var cur = _p6._1;
	return _elm_lang$core$Native_Utils.update(
		m,
...
var _henriiik$vlm$Main$currentLineLength = function (m) {
...
var _henriiik$vlm$Main$motionRight = function (m) {
	return (_elm_lang$core$Native_Utils.cmp(
		m.cursor.col,
		_henriiik$vlm$Main$currentLineLength(m)) > -1) ? m : _elm_lang$core$Native_Utils.update(
		m,
		{
			cursor: _henriiik$vlm$Cursor$right(m.cursor)
		});
};
...
var _henriiik$vlm$Main$insertChar = F2(
	function (c, m) {
		return _henriiik$vlm$Main$motionRight(
			A2(
				_henriiik$vlm$Main$replaceCurrentLine,
				A3(
...
var _henriiik$vlm$Main$renderBuffer = function (m) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('buffer'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
...
var _henriiik$vlm$Main$view = function (m) {
	return A2(
		...
		{
			ctor: '::',
			_0: _henriiik$vlm$Main$renderCursor(m),
			_1: {
				ctor: '::',
				_0: _henriiik$vlm$Main$renderBuffer(m),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('log'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _henriiik$vlm$Main$splitLine = function (m) {
	...
	return _henriiik$vlm$Main$cursorStart(
		A3(
			...
			_elm_lang$core$Tuple$second(split),
			m.cursor.row + 1,
			A2(
				_henriiik$vlm$Main$replaceCurrentLine,
				_elm_lang$core$Tuple$first(split),
				m)));
};
...
var _henriiik$vlm$Main$motionWordBack = function (m) {
	...
	if (_p8.ctor === 'Just') {
		...
		var _p9 = _henriiik$vlm$Main$lastIndex(
			_henriiik$vlm$Main$wordIndexes(
...
var _henriiik$vlm$Main$motionWordEnd = function (m) {
	...
	if (_p11.ctor === 'Just') {
		return _elm_lang$core$Native_Utils.update(
			m,
			{
				cursor: A2(_henriiik$vlm$Cursor$withCol, _p11._0, m.cursor)
			});
	} else {
		var _p12 = A2(
			_henriiik$vlm$Main$nextIndex,
		...
		if (_p12.ctor === 'Just') {
			return _henriiik$vlm$Main$cursorDown(
				_elm_lang$core$Native_Utils.update(
					m,
					{
						cursor: A2(_henriiik$vlm$Cursor$withCol, _p12._0, m.cursor)
					}));
		} else {
...
var _henriiik$vlm$Main$Edit = F4(
	function (a, b, c, d) {
		return {repeat: a, command: b, object: c, motion: d};
	});
var _henriiik$vlm$Main$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {cursor: a, selectionStart: b, buffer: c, register: d, edit: e, width: f, height: g, log: h, mode: i, ctrl: j, shift: k, alt: l};
											};
										};
									};
								};
...
var _henriiik$vlm$Main$deleteSelection = function (m) {
	...
	var _p14 = A3(_henriiik$vlm$Main$cutSelection, m.mode, sel, m.buffer);
	var buf = _p14._0;
	var reg = _p14._1;
	return _elm_lang$core$Native_Utils.update(
		m,
...
var _henriiik$vlm$Main$A = {ctor: 'A'};
var _henriiik$vlm$Main$Inner = {ctor: 'Inner'};
var _henriiik$vlm$Main$Move = {ctor: 'Move'};
var _henriiik$vlm$Main$init = {
	ctor: '_Tuple2',
	_0: _henriiik$vlm$Main$Model(
		A2(_henriiik$vlm$Cursor$Cursor, 0, 0))(
		A2(_henriiik$vlm$Cursor$Cursor, 0, 0))(
		_elm_lang$core$Array$fromList(
			{
				ctor: '::',
				_0: 'this is the buffer',
				_1: {
					ctor: '::',
					_0: 'this is the second line',
					_1: {
						ctor: '::',
						_0: 'this is the third line',
						_1: {
							ctor: '::',
							_0: 'this is the fourth line',
							_1: {
								ctor: '::',
								_0: 'this is the fifth line',
								_1: {
									ctor: '::',
									_0: 'this is the sixth line',
									_1: {
										ctor: '::',
										_0: 'this is the seventh',
										_1: {
											ctor: '::',
											_0: 'this is the eighth line',
											_1: {
												ctor: '::',
												_0: 'this is the ninth line',
												_1: {ctor: '[]'}
											}
										}
									}
		...
		A4(_henriiik$vlm$Main$Edit, 0, _henriiik$vlm$Main$Move, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing))(80)(20)(
		{
			ctor: '::',
			_0: 'this is the log',
			_1: {ctor: '[]'}
		})(_henriiik$vlm$Main$Normal)(false)(false)(false),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _henriiik$vlm$Main$resetCmd = function (mdl) {
	return _elm_lang$core$Native_Utils.update(
		mdl,
		{
			edit: A4(_henriiik$vlm$Main$Edit, 0, _henriiik$vlm$Main$Move, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing)
		});
};
var _henriiik$vlm$Main$doCmdMove = function (mdl) {
	var _p15 = mdl.edit.motion;
	_v13_4:
	do {
		if (_p15.ctor === 'Just') {
			switch (_p15._0.ctor) {
				case 'Right':
					return _henriiik$vlm$Main$resetCmd(
						_henriiik$vlm$Main$motionRight(mdl));
				case 'Left':
					return _henriiik$vlm$Main$resetCmd(
						_henriiik$vlm$Main$motionLeft(mdl));
				case 'Down':
					return _henriiik$vlm$Main$resetCmd(
						_henriiik$vlm$Main$motionDown(mdl));
				case 'Up':
					return _henriiik$vlm$Main$resetCmd(
...
var _henriiik$vlm$Main$doCmdDelete = function (mdl) {
	var _p16 = mdl.edit.motion;
	if (_p16.ctor === 'Just') {
		switch (_p16._0.ctor) {
			case 'Right':
				return _henriiik$vlm$Main$resetCmd(
			...
			case 'Down':
				return _henriiik$vlm$Main$resetCmd(
					_henriiik$vlm$Main$cursorStart(
						A2(
							_henriiik$vlm$Main$removeLineAt,
							mdl.cursor.row,
...
var _henriiik$vlm$Main$Right = {ctor: 'Right'};
var _henriiik$vlm$Main$Left = {ctor: 'Left'};
var _henriiik$vlm$Main$Down = {ctor: 'Down'};
		...
		switch (_p19) {
			...
			case 37:
				return A2(
					...
					m,
					A2(_henriiik$vlm$Main$withEditMotion, _henriiik$vlm$Main$Left, m.edit));
			case 38:
				return A2(
					_henriiik$vlm$Main$withEdit,
					m,
					A2(_henriiik$vlm$Main$withEditMotion, _henriiik$vlm$Main$Up, m.edit));
			case 39:
				return A2(
					_henriiik$vlm$Main$withEdit,
					m,
					A2(_henriiik$vlm$Main$withEditMotion, _henriiik$vlm$Main$Right, m.edit));
			case 40:
				return A2(
					_henriiik$vlm$Main$withEdit,
					m,
					A2(_henriiik$vlm$Main$withEditMotion, _henriiik$vlm$Main$Down, m.edit));
			case 27:
				return _henriiik$vlm$Main$resetCmd(
					_elm_lang$core$Native_Utils.update(
						m,
...
var _henriiik$vlm$Main$doKeyPress = F2(
	function (c, m) {
		...
		if (_p23.ctor === 'Insert') {
			...
			if ((_elm_lang$core$Native_Utils.cmp(c, 48) > -1) && (_elm_lang$core$Native_Utils.cmp(c, 57) < 1)) {
				return A2(
					_henriiik$vlm$Main$withEdit,
					m,
				...
				switch (_p25) {
					...
					case 100:
						return A2(
							_henriiik$vlm$Main$withEdit,
							m,
							A2(_henriiik$vlm$Main$withEditCmd, _henriiik$vlm$Main$Delete, m.edit));
					case 101:
...
var _henriiik$vlm$Main$KeyPress = function (a) {
...
var _henriiik$vlm$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$ups(_henriiik$vlm$Main$KeyUp),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_henriiik$vlm$Main$KeyDown),
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$presses(_henriiik$vlm$Main$KeyPress),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _henriiik$vlm$Main$main = _elm_lang$html$Html$program(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _henriiik$vlm$Main$main !== 'undefined') {
    _henriiik$vlm$Main$main(Elm['Main'], 'Main', undefined);
}
